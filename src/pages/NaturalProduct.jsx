...
const flours=[
  ...
  },
  {
    id: 6,
    name: 'Semolina',
    description: 'Craft wholesome meals with our pure organic semolina (Suji), milled from durum wheat grown naturally without chemicals. ', // Restored
    imageUrl: './images/FoodProductPage/Semolina.jpg',
    imageAlt: 'Semolina', //
  },
  {
    id: 6,
    name: 'All Purpose Flour',
    description: 'Our pure organic all-purpose flour is the versatile essential for all your baking, grown naturally without any chemicals. ', // Restored
    imageUrl: './images/FoodProductPage/allpurposeflour.jpg',
    imageAlt: 'Semolina', //
  },
]
...
const oils=[
  ...
  },
  {
    ...
    imageUrl: './images/FoodProductPage/peanut.jpg',
  ...
  },
  {
    ...
    imageUrl: './images/FoodProductPage/seasame.jpg',
    imageAlt: 'Sesame oil',
  },
...
export function NaturalProductPage() { // Changed to named export as in original file
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      >
        <source src="/videos/natural_product.mp4" type="video/mp4" />
      ...
      {/* --- Page Content --- */}
      <main className="relative z-10 mx-auto max-w-7xl px-4 py-16 md:py-24"> {/* Increased max-width for 2 columns */}
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Explore our collection of carefully crafted and collected natural and organic products.
          </motion.p>
        </motion.div>
